...
curl -fL -o vs_code.deb https://update.code.visualstudio.com/latest/linux-deb-${ARCH}/stable
apt-get update
apt-get install -y ./vs_code.deb

# Desktop icon
mkdir -p /usr/share/icons/hicolor/apps
curl -fL https://kasm-static-content.s3.amazonaws.com/icons/vscode.svg >/usr/share/icons/hicolor/apps/vscode.svg
